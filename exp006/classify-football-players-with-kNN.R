...
shuffled_player_data <- shuffled_player_data[,c(seq(2,8),10,11, seq(13,17),19,22,seq(24,26),34,seq(36,40),seq(44,51),seq(53,56),31)]
...
players_train_labels <- shuffled_player_data[1:1500,38]
players_test_labels <- shuffled_player_data[1501:1800,38]
